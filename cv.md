...
1. 《射雕》UE4 上线项目 - 梦幻事业部 - 动作图形程序 2024.7 - 至今
    * Foot IK 改造，效率提升至子线程0.2ms; Look At IK 效果优化。
    * 角色移动框架维护，解决了穿地，撞墙移动会抖动的问题。新开发大轻功，游泳。
    * 游戏中变身功能。
    * 战斗技能的维护开发。
2. 内部预研项目- 大话事业部 - 动作图形程序 - 2023.8 - 2024.6
    * UE5 引擎，3D ARPG 主角移动预研, 动画规范探索, 竞品动画分析。
3. 《哈利波特 魔法觉醒》- Zen 事业部 - 图形程序 - 2021.10 - 2023.8
...
4. 内部预研项目- Zen 事业部 - 图形程序 - Unity 引擎 -2020.11 - 2021.10
    * 物理效果的尝试，角色时装穿插的解决。
5. G90《猎手之王》- 梦幻事业部 - 程序 - 2018.7 - 2020.11
    * C++重写特效播放模块; 游戏界面显示场景的通用接口; 基于git的自动化分支合并工具。
6. 《梦幻诛仙手游》- 祖龙娱乐 - 程序 - 2017.4 - 2018.6
    * Unity3D + Lua
